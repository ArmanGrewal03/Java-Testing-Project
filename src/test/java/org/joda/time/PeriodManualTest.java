...
public class PeriodManualTest {
    ...
    @Test
    public void test_normalizedStandard_missingYearsMonthsPeriodType_throwsUnsupportedOperationException() {
        // Cover the exceptional branch:
        // throw new UnsupportedOperationException("Unable to normalize ...")
        // when non-zero years/months exist but PeriodType supports neither.
        ...
        assertTrue(ex.getMessage().contains("Unable to normalize as PeriodType is missing either years or months"));
    }
}
